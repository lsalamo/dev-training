...
if __name__ == "__main__":
    ...
    # app
    app = App()
    params = {"from_date": "2022-09-01", "to_date": "2022-12-01"}
    df_usage_logs_1 = app.request(params)
    params = {"from_date": "2022-12-01", "to_date": "2023-03-01"}
    df_usage_logs_2 = app.request(params)
    # merge
    df_usage_logs = f_df.Dataframe.Columns.join_two_frames_by_columns(
        df_usage_logs_1, df_usage_logs_2, ["login"], "outer", None
    )
